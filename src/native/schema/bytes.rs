...
pub(super) fn interpret_binary(
    ...
    // Unbounded `max_size` falls back to a generous ceiling — Hypothesis
    // also truncates generation at some finite cap, and matching that
    // keeps shrinker and cache behaviour sensible.
