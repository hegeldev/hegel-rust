 ...
 *
 * HEGEL_CHECK(ctx, call) aborts with a diagnostic (including the context's
 * last error message) if a libhegel call does not return HEGEL_OK. Use it for
 * the setup / bookkeeping / teardown calls whose only non-zero outcome would
