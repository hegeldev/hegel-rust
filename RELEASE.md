...
This release adds concurrent stateful testing: a state machine whose rules run *concurrently* against the system under test, from a drawn number of worker threads.
