...
This changes the recorded choice sequence of pool draws, so previously saved database entries and `reproduce_failure` blobs for tests using pools no longer reproduce their failures; they fail loudly and should be regenerated.
