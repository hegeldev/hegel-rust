...
Hegel runs entirely in-process as a pure Rust implementation of the underlying
Hegel engine — there is no external server, Python, or other runtime dependency
to install.
